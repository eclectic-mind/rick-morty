import { hasInjectionContext, inject, version, ref, watchEffect, watch, getCurrentInstance, defineAsyncComponent, computed, getCurrentScope, unref, defineComponent, h, provide, shallowReactive, Suspense, nextTick, Fragment, Transition, onScopeDispose, mergeProps, useSSRContext, createApp, effectScope, reactive, onErrorCaptured, onServerPrefetch, createVNode, resolveDynamicComponent, toRef as toRef$1, readonly, customRef, shallowRef, isReadonly, toRaw, withCtx, isRef, isShallow, isReactive } from 'vue';
import { $ as $fetch$1, i as baseURL, j as hasProtocol, k as isScriptProtocol, l as joinURL, w as withQuery, c as createError$1, m as klona, n as defu, s as sanitizeStatusCode, o as defuFn, q as getContext, r as createHooks, t as parse, v as getRequestHeader, x as destr, y as isEqual, z as setCookie, A as getCookie, B as deleteCookie, C as toRouteMatcher, D as createRouter$1 } from '../nitro/nitro.mjs';
import { createPinia, setActivePinia, shouldHydrate } from 'pinia';
import { CapoPlugin, getActiveHead } from 'unhead';
import { defineHeadPlugin, composableNames, whitelistSafeInput, unpackMeta } from '@unhead/shared';
import { useRoute as useRoute$1, RouterView, createMemoryHistory, createRouter, START_LOCATION } from 'vue-router';
import { _api, disableCache, addAPIProvider, setCustomIconsLoader } from '@iconify/vue';
import { createHighlighter } from 'shiki';
import { set, forOwn, isEmpty, pickBy, isNumber, isString, isArray, keys, get } from 'lodash-es';
...
const _routes = [
  {
    name: "characters-character-ch_id",
    path: "/characters/character-:ch_id()",
    component: () => import('./character-_ch_id_-DjJJ0wMh.mjs')
  },
  {
    name: "characters",
    path: "/characters",
    component: () => import('./index-Ipc1GIyf.mjs')
  },
  {
    name: "episodes-episode-e_id",
    path: "/episodes/episode-:e_id()",
    component: () => import('./episode-_e_id_-DmFEvqmm.mjs')
  },
  {
    name: "episodes",
    path: "/episodes",
    component: () => import('./index-DhvSpMKI.mjs')
  },
  {
    name: "favorite",
    path: "/favorite",
    component: () => import('./favorite-DdxlmBon.mjs')
  },
  {
    name: "index",
    path: "/",
    component: () => import('./index-DcZggWQg.mjs')
  },
  {
    name: "locations",
    path: "/locations",
    component: () => import('./index-zSjIPhj6.mjs')
  },
  {
    name: "locations-location-l_id",
    path: "/locations/location-:l_id()",
    component: () => import('./location-_l_id_-CeZvtHZF.mjs')
  }
];
...
const LazyProseA = defineAsyncComponent(() => import('./ProseA-B8_2XGj2.mjs').then((r) => r["default"] || r.default || r));
const LazyProseBlockquote = defineAsyncComponent(() => import('./ProseBlockquote-C1bIL0J5.mjs').then((r) => r["default"] || r.default || r));
const LazyProseCode = defineAsyncComponent(() => import('./ProseCode-C701eWMK.mjs').then((r) => r["default"] || r.default || r));
const LazyProseEm = defineAsyncComponent(() => import('./ProseEm-CtIY3y59.mjs').then((r) => r["default"] || r.default || r));
const LazyProseH1 = defineAsyncComponent(() => import('./ProseH1-DSpA-zPR.mjs').then((r) => r["default"] || r.default || r));
const LazyProseH2 = defineAsyncComponent(() => import('./ProseH2-BlIs9-Ur.mjs').then((r) => r["default"] || r.default || r));
const LazyProseH3 = defineAsyncComponent(() => import('./ProseH3-CrL-Q-Uf.mjs').then((r) => r["default"] || r.default || r));
const LazyProseH4 = defineAsyncComponent(() => import('./ProseH4-Vq-S_4oc.mjs').then((r) => r["default"] || r.default || r));
const LazyProseH5 = defineAsyncComponent(() => import('./ProseH5-Ko3z__e0.mjs').then((r) => r["default"] || r.default || r));
const LazyProseH6 = defineAsyncComponent(() => import('./ProseH6-9S-GMclf.mjs').then((r) => r["default"] || r.default || r));
const LazyProseHr = defineAsyncComponent(() => import('./ProseHr-KLtSZrgC.mjs').then((r) => r["default"] || r.default || r));
const LazyProseImg = defineAsyncComponent(() => import('./ProseImg-CT8_k47X.mjs').then((r) => r["default"] || r.default || r));
const LazyProseLi = defineAsyncComponent(() => import('./ProseLi-DYMQYrf0.mjs').then((r) => r["default"] || r.default || r));
const LazyProseOl = defineAsyncComponent(() => import('./ProseOl-BzZ_iSwP.mjs').then((r) => r["default"] || r.default || r));
const LazyProseP = defineAsyncComponent(() => import('./ProseP-3arCRJIn.mjs').then((r) => r["default"] || r.default || r));
const LazyProsePre = defineAsyncComponent(() => import('./ProsePre-Ei5crZqb.mjs').then((r) => r["default"] || r.default || r));
const LazyProseScript = defineAsyncComponent(() => import('./ProseScript-D0R07iM6.mjs').then((r) => r["default"] || r.default || r));
const LazyProseStrong = defineAsyncComponent(() => import('./ProseStrong-CvLBkW7o.mjs').then((r) => r["default"] || r.default || r));
const LazyProseTable = defineAsyncComponent(() => import('./ProseTable-BTEefSgn.mjs').then((r) => r["default"] || r.default || r));
const LazyProseTbody = defineAsyncComponent(() => import('./ProseTbody-C8ydIGUp.mjs').then((r) => r["default"] || r.default || r));
const LazyProseTd = defineAsyncComponent(() => import('./ProseTd-Dm4mMgDL.mjs').then((r) => r["default"] || r.default || r));
const LazyProseTh = defineAsyncComponent(() => import('./ProseTh-KtOoyplF.mjs').then((r) => r["default"] || r.default || r));
const LazyProseThead = defineAsyncComponent(() => import('./ProseThead-pG5sW2lW.mjs').then((r) => r["default"] || r.default || r));
const LazyProseTr = defineAsyncComponent(() => import('./ProseTr-BbeBENxo.mjs').then((r) => r["default"] || r.default || r));
const LazyProseUl = defineAsyncComponent(() => import('./ProseUl-Cl_S6hp2.mjs').then((r) => r["default"] || r.default || r));
const LazyIcon = defineAsyncComponent(() => import('./index-Du58e3vH.mjs').then((r) => r["default"] || r.default || r));
...
const shiki_aNtZOwkiMT = /* @__PURE__ */ defineNuxtPlugin(async (nuxtApp) => {
  let __temp, __restore;
  const hl = ([__temp, __restore] = executeAsync(() => gethighlighter()), __temp = await __temp, __restore(), __temp);
...
const defaultDocument = undefined;
...
function useBreakpoints(breakpoints, options = {}) {
  ...
  const { window: window2 = defaultWindow$1, strategy = "min-width" } = options;
...
function useElementVisibility$1(element, options = {}) {
  const { window: window2 = defaultWindow$1, scrollTarget, threshold = 0 } = options;
  ...
  useIntersectionObserver$1(
    ...
    (intersectionObserverEntries) => {
      ...
      let latestTime = 0;
      for (const entry2 of intersectionObserverEntries) {
        if (entry2.time >= latestTime) {
          latestTime = entry2.time;
          isIntersecting = entry2.isIntersecting;
        }
      }
...
function useEventBus(key) {
  ...
  function on(listener) {
    ...
    (_a = scope == null ? undefined : scope.cleanups) == null ? undefined : _a.push(_off);
    return _off;
  }
  ...
  function emit(event, payload) {
    var _a;
    (_a = events.get(key)) == null ? undefined : _a.forEach((v) => v(event, payload));
  }
...
const vOnKeyStroke = {
  [directiveHooks.mounted](el, binding) {
    var _a, _b;
    const keys2 = (_b = (_a = binding.arg) == null ? undefined : _a.split(",")) != null ? _b : true;
    if (typeof binding.value === "function") {
...
const vueuse_OEgG99GgUe = /* @__PURE__ */ defineNuxtPlugin((nuxtApp) => {
...
const breakpoint_A94uY76UEY = /* @__PURE__ */ defineNuxtPlugin((nuxtApp) => {
...
function useModuleOptions() {
  const options = (/* @__PURE__ */ useRuntimeConfig()).public.usebootstrap;
  return options.dynamicRoute;
}
function useDynamicRouteParam(paramName) {
  const route = useRoute();
  const options = useModuleOptions();
  return computed(() => {
    return route.params[paramName] || get(options == null ? undefined : options.defaults, paramName);
  });
}
const localization_4muIV3rQ3Y = /* @__PURE__ */ defineNuxtPlugin((nuxtApp) => {
  nuxtApp.hook("page:loading:start", () => {
...
const seometa_PUjXh2I6u6 = /* @__PURE__ */ defineNuxtPlugin((nuxtApp) => {
  nuxtApp.hook("page:loading:start", () => {
    const lang = useDynamicRouteParam("lang");
    const route = useRoute();
    useSeoMeta({
...
function hProps(...items) {
  ...
  items.forEach((item) => {
    ...
    forOwn(item.event, (value, key) => {
      var _a;
      if (events2.has(key)) {
        (_a = events2.get(key)) == null ? undefined : _a.push(value);
      } else {
        const funcs = [value];
        events2.set(key, funcs);
        const val = (payload) => {
          var _a2;
          (_a2 = events2.get(key)) == null ? undefined : _a2.forEach((func) => func(payload));
        };
        result[key] = val;
      }
    });
...
function hSlots(...slots) {
  return slots.map((value) => {
    return value ? value() : undefined;
  });
}
function addClassNames$1(value, func) {
  const classObject = {};
...
function exposeMethods(context, ...items) {
  const result = {};
  ...
  items.forEach((item) => {
    forOwn(item.method, (value, key) => {
      var _a;
      if (methods.has(key)) {
        (_a = methods.get(key)) == null ? undefined : _a.push(value);
      } else {
        const funcs = [value];
        methods.set(key, funcs);
        const val = (...payloads) => {
          var _a2;
          (_a2 = methods.get(key)) == null ? undefined : _a2.forEach((func) => func(payloads));
        };
        result[key] = val;
      }
    });
...
const bootstrap_05n8Uo6bmP = /* @__PURE__ */ defineNuxtPlugin((nuxtApp) => {
...
setSSRHandler("getDefaultStorage", () => {
  ...
  return {
    ...
    removeItem: (key) => get2(key).value = undefined
  };
});
{
...
const ssr_plugin_B4ptqVdIfe = /* @__PURE__ */ defineNuxtPlugin(() => {
});
const plugins = [
  payloadPlugin,
  unhead_KgADcZ0jPj,
...
const layouts = {
  default: defineAsyncComponent(() => import('./default-DO4j83HB.mjs').then((m) => m.default || m))
};
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const _Error404 = defineAsyncComponent(() => import('./error-404-BMuduGi8.mjs'));
    const _Error = defineAsyncComponent(() => import('./error-500-Bd-xrC3V.mjs'));
...
export { asyncDataDefaults as A, createError as B, useAppConfig as C, _export_sfc as _, useRoute as a, addProp as b, hSlots as c, defaultDocument as d, entry$1 as default, useEventBus as e, useElementHover$1 as f, useElementVisibility$1 as g, hProps as h, isPropUndefined as i, useModuleOptions as j, unrefElement$1 as k, useIntersectionObserver$1 as l, exposeMethods as m, addClassNames$1 as n, useRuntimeConfig as o, useRequestEvent as p, useNuxtApp as q, useRouter as r, nuxtLinkDefaults as s, toArray as t, useHead as u, resolveRouteObject as v, navigateTo as w, spacing as x, hasValue as y, isPropDefined as z };
