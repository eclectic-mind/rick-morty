...
import { Icon as Icon$1, getIcon, loadIcon as loadIcon$1 } from '@iconify/vue';
import { getIconCSS } from '@iconify/utils/lib/css/icon';
import { q as useNuxtApp, C as useAppConfig, o as useRuntimeConfig, u as useHead, A as asyncDataDefaults, B as createError } from './server.mjs';
...
function useResolvedName(getName) {
  ...
  return computed(() => {
    ...
    const resolved = ((_a = options.aliases) == null ? undefined : _a[bare]) || bare;
  ...
  setup(props) {
    ...
    onServerPrefetch(async () => {
      var _a;
      {
        ...
        if (!((_a = configs == null ? undefined : configs.serverKnownCssClasses) == null ? undefined : _a.includes(cssClass.value))) {
...
const Icon = defineComponent({
  ...
  setup(props, { slots }) {
    ...
    const component = computed(
      () => {
        var _a;
        return ((_a = nuxtApp.vueApp) == null ? undefined : _a.component(name.value)) || ((props.mode || runtimeOptions.mode) === "svg" ? NuxtIconSvg : NuxtIconCss);
      }
    );
...
//# sourceMappingURL=index-Du58e3vH.mjs.map
