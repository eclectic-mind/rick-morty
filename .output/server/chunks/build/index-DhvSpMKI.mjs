...
import { _ as _sfc_main$1 } from './EpisodeLink-DHF1ihjU.mjs';
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      const _component_EpisodeLink = _sfc_main$1;
          ...
          if (_push2) {
            _push2(ssrRenderComponent(_component_Row, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<h4 class="title" data-v-cfda33f4${_scopeId2}>\u042D\u043F\u0438\u0437\u043E\u0434\u044B</h4><p class="text-secondary" data-v-cfda33f4${_scopeId2}>\u0412\u0441\u0435\u0433\u043E: ${ssrInterpolate(unref(myStore).count)}</p><ul data-v-cfda33f4${_scopeId2}><!--[-->`);
                  ssrRenderList(unref(myStore).items, (elem) => {
                    _push3(`<li data-v-cfda33f4${_scopeId2}>`);
                  ...
                  _push3(`<!--]--></ul><nav aria-label="pagination" data-v-cfda33f4${_scopeId2}>`);
                  ...
                  return [
                    createVNode("h4", { class: "title" }, "\u042D\u043F\u0438\u0437\u043E\u0434\u044B"),
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/episodes/index.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : undefined;
};
const index = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-cfda33f4"]]);

export { index as default };
//# sourceMappingURL=index-DhvSpMKI.mjs.map
